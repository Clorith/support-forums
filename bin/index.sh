...
npm run wp-env run cli "wp post create --post_type=plugin --post_status=publish --post_author=4 --post_title='Hello Dolly' --url=localhost:8888/plugins"
...
npm run wp-env run cli "wp post create --post_type=forum --post_status=publish --post_title='Installing WordPress' --post_content='If you encounter any problems while setting up WordPress.'"
npm run wp-env run cli "wp post create --post_type=forum --post_status=publish --post_title='Fixing WordPress' --post_content='For any problems encountered after setting up WordPress.'"
npm run wp-env run cli "wp post create --post_type=forum --post_status=publish --post_title='Plugins' --post_content='Forum for plugin-specific support topics (hidden on WordPress.org).'"
npm run wp-env run cli "wp post create --post_type=forum --post_status=publish --post_title='Themes' --post_content='Forum for theme-specific support topics (hidden on WordPress.org).'"
npm run wp-env run cli "wp post create --post_type=forum --post_status=publish --post_title='Reviews' --post_content='Forum for plugin and theme reviews (hidden on WordPress.org).'"
